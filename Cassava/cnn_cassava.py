...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--image_dir',
      type=str,
      default='/home/amanda/Desktop/tensorflow/cassava/images_test',
      help='Path to folders of labeled images.'
  )
  parser.add_argument(
      '--output_graph',
      type=str,
      default='/home/amanda/Desktop/tensorflow/cassava/output_graph_bls2_bsd.pb',
      help='Where to save the trained graph.'
  )
  parser.add_argument(
      '--intermediate_output_graphs_dir',
      type=str,
      default='/home/amanda/Desktop/tensorflow/cassava/intermediate_graph/',
  ...
  parser.add_argument(
      '--output_labels',
      type=str,
      default='/home/amanda/Desktop/tensorflow/cassava/output_labels.txt',
      help='Where to save the trained graph\'s labels.'
  )
  parser.add_argument(
      '--summaries_dir',
      type=str,
      default='/home/amanda/Desktop/tensorflow/cassava/retrain_logs',
  ...
  parser.add_argument(
      '--bottleneck_dir',
      type=str,
      default='/home/amanda/Desktop/tensorflow/cassava/bottleneck',
